        ...
        <div className="tool-wrapper__sidebar">            
            ...
            {selectedView === 'bubble' ?
                <div className="tool-wrapper__sidebar--desc">
                    {selectedIndustry === 'Athletic Apparel' && <p>The overall imbalance favoring <span className="font-text-bold emerald">Demand-side</span> functions exceeds 2:1 for brands producing “soft goods” where detailed documentation of the manufacturing process suffers in favor of the product use and sustainability of apparel and footwear with a short, limited lifespan.</p>}
                    ...
                    {selectedIndustry === 'Food & Beverage' && <p>Among the most “balanced” industries across competing function (with one notable exception), Food & Beverages reflects a wider reliance on indirect distribution channels and wholesalers to <span className="font-text-bold emerald">sell</span> perishable product to consumers.</p>}
                    ...
                    {selectedIndustry === 'Retail & Grocery' && <p>Apart from select private label brands, Retail & Grocery represents the primary distribution channels for three other industries represented in this sample, eclipsing all of them in <span className="font-text-bold emerald">product use</span> by double digits.</p>}
