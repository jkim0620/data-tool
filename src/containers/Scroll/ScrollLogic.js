...
const ScrollLogic = () => {    
    ...
    const mapSteps = [1, 2, 3, 4, 5,].map((_, stepIndex) => (
        <Step data={stepIndex} key={stepIndex}>
            ...
            {stepIndex === 4 && <div className="scroll-el-filter white"><div className=""><p className="white font-text-bold tac scroll-el-filter__cta">Explore how this imbalance shifts by industry:</p></div><Filter /></div>}
            </div>
        </Step>
    ))
